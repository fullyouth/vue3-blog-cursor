import{m as R,h as X,c as F}from"./index-CE52kcC0.js";const it=R("blog",()=>{const $=X([{id:1,title:"Vue3 组合式API入门指南",excerpt:"Vue3的组合式API为我们提供了更灵活的逻辑复用方式，本文将详细介绍其使用方法...",content:`# Vue3 组合式API入门指南
